...
interface SelectProps extends Props<SelectType, HTMLDivElement>{
    ...
    position?: 'top' | 'bittom',
    selectedFormat?: (label: string) => string;
}
...
export const Component: UIElement<SelectProps> = props => {
    ...
    const getLabel = () =>
		(selected => selected ? (label => props.selectedFormat ? props.selectedFormat(label) : label)(selected.props.children) : props.placeholder)(getSelectedElement())
